...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:19 GMT -->
<head>
...
<body class="light-d">
  ...
  <section class="team-style-one gap">
  ...
  <div class="modal fade popups conslt-popup" id="exampleModal" tabindex="-1" aria-hidden="true">
    ...
    </div><div class="modal fade popups conslt-popup" id="exampleModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:21 GMT -->
</html>
