...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/our-classes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:37 GMT -->
<head>
...
<body class="light-d">
  ...
  <section class="gap project-completed our-projects-one">
    <div class="prj-post">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="proj-data">
              ...
              <p>Lorem ipsum dolor sit amet, consec tetur adipi scing elit. Quisque eget  amet, consec tetu augue ante, sed bibend umigula.</p>
              <div class="loc-date">
                <div>
                  <span>LOCATION:</span>
          ...
          <div class="col-lg-6">
            <div class="data reveal1 it-reveal-animation">
              <figure>
                <img src="assets/images/project-img-1.jpg" alt="Our Project One Image 1">
              </figure>
            </div>
          </div>
        </div>
    ...
    <div class="prj-post">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="proj-data">
              <h3><a href="project-detail.html">Olympic Crossfit</a></h3>
              <p>Lorem ipsum dolor sit amet, consec tetur adipi scing elit. Quisque eget  amet, consec tetu augue ante, sed bibend umigula.</p>
              <div class="loc-date">
                <div>
                  <span>LOCATION:</span>
          ...
          <div class="col-lg-6">
            <div class="data reveal1 it-reveal-animation">
              <figure>
                <img src="assets/images/project-img-2.jpg" alt="Our Project One Image 2">
              </figure>
            </div>
          </div>
        </div>
    ...
    <div class="prj-post">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="proj-data">
              <h3><a href="project-detail.html">Cool and Calm Yoga</a></h3>
              <p>Lorem ipsum dolor sit amet, consec tetur adipi scing elit. Quisque eget  amet, consec tetu augue ante, sed bibend umigula.</p>
              <div class="loc-date">
                <div>
                  <span>LOCATION:</span>
          ...
          <div class="col-lg-6">
            <div class="data reveal1 it-reveal-animation">
              <figure>
                <img src="assets/images/project-img-3.jpg" alt="Our Project One Image 3">
              </figure>
            </div>
          </div>
        </div>
    ...
    <div class="prj-post">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="proj-data">
              <h3><a href="project-detail.html">Weight Lifting</a></h3>
              <p>Lorem ipsum dolor sit amet, consec tetur adipi scing elit. Quisque eget  amet, consec tetu augue ante, sed bibend umigula.</p>
              <div class="loc-date">
                <div>
                  <span>LOCATION:</span>
          ...
          <div class="col-lg-6">
            <div class="data reveal1 it-reveal-animation">
              <figure>
                <img src="assets/images/project-img-4.jpg" alt="Our Project One Image 4">
              </figure>
            </div>
          </div>
        </div>
    ...
    <div class="prj-post">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="proj-data">
              <h3><a href="project-detail.html">Cross Training</a></h3>
              <p>Lorem ipsum dolor sit amet, consec tetur adipi scing elit. Quisque eget  amet, consec tetu augue ante, sed bibend umigula.</p>
              <div class="loc-date">
                <div>
                  <span>LOCATION:</span>
          ...
          <div class="col-lg-6">
            <div class="data reveal1 it-reveal-animation">
              <figure>
                <img src="assets/images/project-img-5.jpg" alt="Our Project One Image 5">
              </figure>
            </div>
          </div>
        </div>
    ...
    <div class="prj-post">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="proj-data">
              <h3><a href="project-detail.html">Mastering the Art</a></h3>
              <p>Lorem ipsum dolor sit amet, consec tetur adipi scing elit. Quisque eget  amet, consec tetu augue ante, sed bibend umigula.</p>
              <div class="loc-date">
                <div>
                  <span>LOCATION:</span>
          ...
          <div class="col-lg-6">
            <div class="data reveal1 it-reveal-animation">
              <figure>
                <img src="assets/images/project-img-6.jpg" alt="Our Project One Image 6">
              </figure>
            </div>
          </div>
        </div>
