...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:18:58 GMT -->
<head>
  <meta charset="utf-8">
...
<body class="light-d">
 ...
 <header class="header-style-one two">
    <div class="top-bar">
      <h4>EURO TRIPLE - 3 SESSIONS FOR JUST £45. BUY NOW.</h4>
    </div>
    <div class="container">
      <div class="row">
  ...
  <section class="myslider owl-carousel owl-theme"> 
    <div data-dot="<button><span>01</span> Workout Classes</button>" class=" item featured-section-three" style="background-image:url(assets/images/video-popup-img.jpg);">
     <div class="container">
    ...
    <div data-dot="<button><span>02</span> Cardio Program</button>" class=" item featured-section-three" style="background-image:url(assets/images/video-popup-img-2.jpg);">
     <div class="container">
        <div class="featured-text-two">
    ...
    <div data-dot="<button><span>03</span> Fitness Studio </button>" class=" item featured-section-three" style="background-image:url(assets/images/video-popup-img-3.jpg);">
     <div class="container">
        <div class="featured-text-two">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="history-data reveal1 it-reveal-animation">
            <figure>
              <img class="w-100" src="assets/images/crain.jpg" alt="Crain Image">
            </figure>
            <div class="details">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="history-data reveal1 it-reveal-animation">
            <figure>
              <img class="w-100" src="assets/images/c-man.jpg" alt="C-Man Image">
            </figure>
            <div class="details">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="history-data reveal1 it-reveal-animation">
            <figure>
              <img class="w-100" src="assets/images/building.jpg" alt="Building Image">
            </figure>
            <div class="details">
  ...
  <section class="cta-section reveal1 it-reveal-animation">
    <div class="container">
    ...
    <div class="container">
      <div class="row p-slider owl-carousel">
        ...
        <div class="col-lg-12">
          <div class="product">
            <figure>
              <img class="w-100" src="assets/images/product-5.png" alt="Product Image 2">
            </figure>
            <div class="btn-hover"> 
              <a href="cart.html" class="theme-btn">Add to Cart <i class="fa-solid fa-bag-shopping"></i></a>
            </div>
        ...
        <div class="col-lg-12">
          <div class="product">
            <figure>
              <img class="w-100" src="assets/images/product-7.png" alt="Product Image 3">
            </figure>
            <div class="btn-hover"> 
              <a href="cart.html" class="theme-btn">Add to Cart <i class="fa-solid fa-bag-shopping"></i></a>
            </div>
        ...
        <div class="col-lg-12">
          <div class="product">
            <figure>
              <img class="w-100" src="assets/images/product-10.png" alt="Product Image 4">
            </figure>
            <div class="btn-hover"> 
              <a href="cart.html" class="theme-btn">Add to Cart <i class="fa-solid fa-bag-shopping"></i></a>
            </div>
  ...
  <section class="gap" >
    ...
    <div class="marquee_text reveal1 it-reveal-animation">
        ...
        <a href="team-detail.html">
          <div class="team-style-2">
            <figure>
              <img src="assets/images/team-4.jpg" alt="IMG">
            </figure>
            <span>Fitness Instructor</span>
        ...
        <a href="team-detail.html">
          <div class="team-style-2">
            <figure>
              <img src="assets/images/team-5.jpg" alt="IMG">
            </figure>
            <span>Fitness Instructor</span>
            <h5>Oliver Rankis</h5>
          </div>
        ...
        <a href="team-detail.html">
          <div class="team-style-2">
            <figure>
              <img src="assets/images/team-6.jpg" alt="IMG">
            </figure>
            <span>Fitness Instructor</span>
            <h5>Moniqa Linda</h5>
          </div>
  ...
  <section class="gap payment-product" style="background-image:url(assets/images/f-slider-one-1.jpg);">
    <div class="heading">
      <figure>
        <img src="assets/images/heading-icon.png" alt="heading-icon-2">
      </figure>
     ...
     <div class="container">
       <div class="row">
         <div class="col-lg-6 reveal1 it-reveal-animation">
           <div class="payment-product-card">
            <img src="assets/images/gym-boy-1.png" alt="img">
         ...
         <div class="col-lg-6 reveal1 it-reveal-animation">
           <div class="payment-product-card">
            <img src="assets/images/gym-girl-1.png" alt="img">
              <h5>Full Membership</h5>  
              <h2>$55.00</h2>
              <span>Subscription Type</span>
              <select id="inputState-111" class="form-control">
  ...
  <section class="contact-form-one gap no-bottom">
     <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="together reveal1 it-reveal-animation">
  ...
  <section class="gap blog-style-three">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 reveal1 it-reveal-animation">
          <div class="blog-posts row">
            <div class="col-lg-6 col-md-6 col-sm-12">
              <div class="boxx">
                <figure>
                  <img src="assets/images/blog-1.jpg" alt="Blog Image 1">
                </figure>
                <div class="space">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <div class="boxx">
                <figure>
                  <img src="assets/images/blog-img-2.jpg" alt="Blog Image 2">
                </figure>
                <div class="space">
                  <span class="date">January 9, 2025</span>
                  <h3>
...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:08 GMT -->
</html>