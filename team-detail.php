...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/team-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:41 GMT -->
<head>
...
<body class="light-d">
  ...
  <section class="gap blog-style-one team-detail detail-page">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="team-data">
                ...
                <ul class="t-contact">
                  ...
                  <li>
                    ...
                    <p>2 Years in the gym fitness center experience.</p>
                  </li>
                </ul> 
                <div class="t-tel">
                  <div class="data">
                    ...
                    <div class="t-sec">
                      <p>Telephone:</p>
                      <span><b>Tel:</b><a href="callto:(+380)503184707">  (+380) 50 318 47 07</a></span> 
                    </div>
                    <div class="gym-time"><h4>Timing:</h4><span>  Mon to Sat : 08 pm to 12 am</span></div>
                  </div>
                  <a href="javascript:void(0)" class="theme-btn">Get a Consultation </a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="image reveal1 it-reveal-animation">
                <figure>
                  <img src="assets/images/team-detail-1.jpg" alt="Team Detail Image One">
                </figure>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="t-detail">
              <h3>What is your professional passion?</h3>
              ...
              <div class="service-detail-first detail-page">
