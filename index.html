...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:18:15 GMT -->
<head>
...
<body class="light-d">
  ...
  <section class="featured-slider-one" style="background: grey; background-image: url(assets/images/f-slider-one-1.jpg);">
      ...
      <div class="ro f-slider-one owl-carousel">
        <div class="f-slider-layer">
          ...
          <svg width="261" height="235" viewBox="0 0 261 235" xmlns="http://www.w3.org/2000/svg">
              <path d="M261 0L190.483 144.088H128.135L162.104 102.062L188.333 45.885H89.8666L70.0873 87.4818H117.815L0 235L49.0181 125.219H0L61.9176 0H261Z" />
          </svg> 
        </div>  
        <div class="f-slider-layer">
           <div class="f-slider-one-data">
  ...
  <section class="gap service-style-one">
    <div class="heading">
      ...
      <span>Build your body strong</span>
  ...
  <section class="gap no-top about-style-one">
    <div class="container">
      <div class="row">
        <div class="col-lg-6" >
          <div class="about-data-left reveal1 it-reveal-animation">
            <figure>
              <img src="assets/images/about-one.jpg" alt="About One">
            </figure>
            <figure>
              <img src="assets/images/about-two.jpg" alt="About One">
            </figure>
        ...
        <div class="col-lg-6" >
          <div class="about-data-right">
            ...
            <div class="about-info">
              ...
              <figure>
                <img class="light-icon" src="assets/images/signature.png" alt="Signature">
                <img class="dark-icon" src="assets/images/signature-1.png" alt="Signature">
              </figure>
              <h3>Marqo Oliva</h3>
              <h4>Director and CEO of Gym Center</h4>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="gap project-style-one pb-0 light-bg-color">
    <div class="heading">
      <figure>
        <img src="assets/images/heading-icon.png" alt="Heading Icon">
      </figure>
      ...
      <div class="row g-0 reveal1 it-reveal-animation">
        <div class="col-lg-6">
        ...
        <div class="col-lg-4">
          <div class="project-post">
            <figure>
              <img src="assets/images/project-img-3.jpg" alt="project-img-1">
            </figure>
            <div class="project-data">
        ...
        <div class="col-lg-4">
          <div class="project-post">
            <figure>
              <img src="assets/images/project-img-4.jpg" alt="project-img-1">
            </figure>
            <div class="project-data">
        ...
        <div class="col-lg-4">
          <div class="project-post">
            <figure>
              <img src="assets/images/project-img-5.jpg" alt="project-img-1">
            </figure>
            <div class="project-data">
...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:18:48 GMT -->
</html>
