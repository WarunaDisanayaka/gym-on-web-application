...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/service-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:35 GMT -->
<head>
  ...
  <section class="gap about-first service-detail-first detail-page">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="who-we-are">
            <div>
              <h3>Friendly & Relax environment</h3>
              <p>focused on maintaining a healthy lifestyle. To cater to the physical well-being of the probationers a number of sports facilities are available in the Academy which includes: <span>sports grounds for cricket, football,</span> basketball, volleyball, jogging track, tennis courts, badminton courts etc. In addition to these, indoor facilities for Snooker and Squash are also available. A Gymnasium situated near the sports ground is also available. It is equipped with the latest fitness equipment ensuring a wide range of exercise options for strength training, cardio and flexibility.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="who-we-are">
            <div>
               <ul>
                <li>Regular physical activity can help you fall asleep faster, get better sleep</li>
                <li>Exercise sends oxygen and nutrients to your tissues and helps your cardiovascular system work </li>
                <li>A gym session or brisk walk can help. Physical activity stimulates many brain chemicals</li>
                <li>Exercise combats health conditions and diseases</li>
                <li>A New Art of Fitness in your Town</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="row s-d-gallery">
        <div class="col-lg-12">
          <figure>
            <a data-fancybox="gallery" href="assets/images/service-detail-1.jpg">
              <img class="img-fluid w-100" src="assets/images/service-detail-1.jpg" alt="service-detail-1" >
            </a>
          </figure>
        </div>
      </div>
      <div class="row s-d-gallery">
        <div class="col-lg-3 col-md-6 col-sm-12" >
          <figure>
            <a data-fancybox="gallery" href="assets/images/service-detail-3.jpg">
              <img class="img-fluid w-100" src="assets/images/service-detail-3.jpg" alt="service-detail-3" >
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12" >
          <figure>
            <a data-fancybox="gallery" href="assets/images/service-detail-2.jpg">
              <img class="img-fluid w-100" src="assets/images/service-detail-2.jpg" alt="service-detail-2" >
            </a>
          </figure>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12" >
          <figure>
            <a data-fancybox="gallery" href="assets/images/service-detail-4.jpg">
              <img class="img-fluid w-100" src="assets/images/service-detail-4.jpg" alt="service-detail-4" >
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12" >
          <figure>
            <a data-fancybox="gallery" href="assets/images/service-detail-5.jpg">
              <img class="img-fluid w-100" src="assets/images/service-detail-5.jpg" alt="service-detail-5" >
            </a>
          </figure>
        </div>
      </div>
              ...
              <p class="mt-0">During the CrossFit Boxing Challenge, you’ll engage in a dynamic workout regimen that incorporates elements of strength training, cardiovascular conditioning, agility, and coordination. Under the guidance of experienced coaches, you’ll learn proper boxing techniques, footwork, and defensive maneuvers, all while pushing yourself through a series of intense CrossFit workouts. Each session will challenge your physical and mental resilience, building not only strength but also enhancing your endurance and mental toughness.</b>The CrossFit Boxing Challenge is designed for individuals of all fitness levels, whether you’re a seasoned athlete or new to both CrossFit and boxing.<br><br> Beyond the physical benefits, the CrossFit Boxing Challenge offers a supportive and motivating community atmosphere. You’ll join a group of like-minded individuals who share a passion for pushing boundaries, cheering each other on, and celebrating victories together.</p>
               <div class="innovation" >
                ...
                <ul>
                  ...
                  <li>
                    <i class="fa-solid fa-check"></i>
                    <p>The camaraderie and sense</p>
                  </li>
                  <li>
                    <i class="fa-solid fa-check"></i>
                    <p>Transformation and witness</p>
                  </li>
                  <li>
                    <i class="fa-solid fa-check"></i>
                    <p>Motivating community</p>
                  </li>
                  <li>
                    <i class="fa-solid fa-check"></i>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="heading-Three">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-Three" aria-expanded="false" aria-controls="collapse-Three">
                        Guidelines highlight that any amount of physical activity?
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="heading-Five">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-Five" aria-expanded="false" aria-controls="collapse-Five">
                        What are 5 fitness workout tips?
                      </button>
                    </h2>
...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/service-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:37 GMT -->
</html>
