...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/our-classes-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:37 GMT -->
<head>
  ...
  <section class="gap project-style-one addition">
    <div class="container">
      <div class="row project-slider">
        <div class="col-lg-6">
          <div class="project-post reveal1 it-reveal-animation">
            <figure>
        ...
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img src="assets/images/project-img-6.jpg" alt="project-img-1">
            </figure>
            <div class="project-data">
                <h4>Monday: 8pm - 11pm</h4>
                <h3><a href="project-detail.html">Bench Press</a></h3>  
        ...
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img src="assets/images/project-img-7.jpg" alt="project-img-1">
            </figure>
            <div class="project-data">
                <h4>Sunday: 8pm - 11pm</h4>
                <h3><a href="project-detail.html">Fitness Ball</a></h3>  
        ...
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img src="assets/images/project-img-8.jpg" alt="project-img-1">
            </figure>
            <div class="project-data">
                <h4>Monday: 8pm - 11pm</h4>
                <h3><a href="project-detail.html">Bench Press</a></h3>  
...
<!-- Mirrored from winsfolio.net/html/gymon/gym-on-drak/our-classes-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 11:19:38 GMT -->
</html>
